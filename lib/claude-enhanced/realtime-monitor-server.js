...
class FrontendFlowMonitorServer {
  ...
  detectTechStack(demand) {
    ...
    if (demand.toLowerCase().includes('tailwind') || demand.toLowerCase().includes('estil')) {
      stack.push('TailwindCSS');
    }
    if (demand.toLowerCase().includes('next')) {
      stack.push('Next.js');
    }
    if (demand.toLowerCase().includes('redux') || demand.toLowerCase().includes('estado')) {
      stack.push('Redux');
    }
    if (demand.toLowerCase().includes('shadcn') || demand.toLowerCase().includes('ui')) {
