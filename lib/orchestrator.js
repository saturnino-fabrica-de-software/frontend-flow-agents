...
Trabalhe de forma 100% autônoma - você tem controle total sobre o processo.`;
    ...
    // For now, always use simulation mode until Claude integration is fully configured
    // This ensures the system works even without Claude API access
    const result = await claude.executeAgent(
      ...
      masterTask,
      {
        ...
        fallback: true  // Always use fallback/simulation for now
      }
    );
