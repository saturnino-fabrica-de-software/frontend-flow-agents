...
async function classifyDemand(demand, projectInfo) {
  ...
  const agentSelectors = {
    // GitHub integration - only for complex features or explicitly requested
    github: () => {
      if (demandLower.includes('pull request') ||
          demandLower.includes('pr') ||
          demandLower.includes('github') ||
          demandLower.includes('workflow') ||
          demandLower.includes('ci/cd') ||
          demandLower.includes('deploy') ||
          (demandLower.includes('feature') && demandLower.includes('completa')) ||
