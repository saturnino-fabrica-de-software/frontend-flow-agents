...
async function runPipeline(demand, projectPath, options = {}) {
  ...
  const classification = await classifyDemand(demand, projectInfo, options);
  ...
  const result = await executePipeline(classification, demand, projectPath, frontendFlowDir, claude, options);
