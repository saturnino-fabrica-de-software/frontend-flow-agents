...
class TechnicalRoundtablePromptGenerator {
  ...
  generatePrompt(demand, projectPath) {
    ...
    // Adicionar instrução clara para o Claude executar a análise
    const prompt = `Você é um assistente IA especializado em desenvolvimento Frontend. Execute uma análise completa seguindo o formato de Mesa Técnica abaixo.

# Mesa Técnica Frontend Flow - 13 Especialistas
